                                    ...
                                    <div class="row">
                                                        ...
                                                        <select name="category" class="form-control" id="category">
                                                            ...
                                                            @foreach ($category as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ isset($single) && $item->id == $single->category_id ? 'selected' : '' }}>
                                                                    {{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        <input type="text" name="product" value="{{ $single->name }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        <input type="text" name="qty" value="{{ $single->qty }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        <textarea type="text" name="description" class="form-control" placeholder="Description">{{ $single->description }}</textarea>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row mb-4 align-items-center">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        <input type="file" name="image[]" value="{{ $single->image }}"
                                                            class="form-control" id="mailInput" multiple>
                                                    </div>
                                                    <small class="text-danger error" id="image_error"></small>
                                                </div>
                                            </div>
                                            @php
                                                $images = json_decode($single->image, true);
                                            @endphp

                                            @if (is_array($images) && count($images))
                                                <div class="d-flex flex-wrap gap-2 mt-1">
                                                    @foreach ($images as $img)
                                                        <img src="{{ asset('storage/' . $img) }}" height="50"
                                                            width="50" class="rounded border" alt="Product Image">
                                                    @endforeach
                                                </div>
                                            @else
    ...
    <script>
        $(document).ready(function() {
            $('#productform').submit(function(e) {
                ...
                $('.error').text('');
                var url = "{{ route('ProductUpdatePage') }}";
