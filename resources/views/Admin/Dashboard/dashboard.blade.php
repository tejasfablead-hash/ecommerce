                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark">Categories<span class="counter"></span><span class="counter"></span></div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">{{$category}}</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark"><span class="counter">Products</span><span class="counter"></span></div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">{{$product}}</h3>
                                        </div>
                                    </div>
                                    {{-- <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark"><span class="counter">Orders</span><span class="counter"></span></div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        <div class="avatar-text avatar-lg bg-gray-200">
                                            <i class="feather-users"></i> </span>
                                        </div>
                                        <div>
                                            <div class="fs-4 fw-bold text-dark"><span class="counter">Customers</span></div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">{{$user}}</h3>
                                        </div>
                                    </div>
                                    {{-- <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
