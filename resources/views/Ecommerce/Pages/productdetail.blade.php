            ...
            <div class="container">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <p>E-commerce is the online buying and selling of goods and services {{ $product->description }}</p>
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="review" role="tabpanel" aria-labelledby="review-tab">
                        <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="box_total">
                                            ...
                                            @if ($feedback->count() == 0)
                                                <h4>01</h4>
                                            @else
                                                <h4>0{{ $feedback->count() }}</h4>
                                            @endif
                                            <h6>(0{{ $feedback->count() == 0 ? '1' : $feedback->count() }} Reviews)</h6>
                                        </div>
                                    </div>
                                    {{-- <div class="col-6">
                                        <div class="rating_list">
                                            <h3>Based on {{ $feedback->count() == 0 ? '1' : $feedback->count() }} Reviews
                                            </h3>
                                            {{-- <ul class="list">
                                    ...
                                    @forelse($feedback as $item)
                                        <div class="review_list mt-3">
                                            <div class="review_item">
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="{{ asset('/storage/user/' . $item->user->image) }}"
                                                            class="img-fluid " height="50px" width="50px"
                                                            alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4>{{ ucfirst($item->user->name) }}</h4>
                                                        <div class="rating">
                                                            @for ($i = 1; $i <= 5; $i++)
                                                                @if ($i <= $item->rating)
                                                ...
                                                <p> Product quality is really good and works as expected. Packaging was
                                                    nice. Just felt the price could be slightly lower, otherwise
                                                    perfect.{{ $item->message }}</p>
                                            </div>
                                    ...
                                    @empty
                                        <div class="review_list mt-3">
                                            <div class="review_item">
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="{{ asset('img/product/review-1.png') }}" height="50px"
                                                            width="50px" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4>Ajit Pawar</h4>
                                                ...
                                                <p>Product quality is really good and works as expected. Packaging was nice.
                                                    Just felt the price could be slightly lower, otherwise perfect.</p>
                                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                @if ($feedbackOrder && $feedbackOrder->orderitem->count())
                                    <div class="review_box">
                                        ...
                                        <p>Outstanding</p>
                                        <form id="feedback" action="" class="contact_form "
                                            novalidate="novalidate">
                                            @csrf
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="hidden" name="order_id"
                                                        value="{{ $feedbackOrder->id }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control" id="email"
                                                        ...
                                                        value="{{ $feedbackOrder->orderitem->first()->product_id }}"
                                                        onfocus="this.placeholder = ''"
                                                        onblur="this.placeholder = 'product_id'">
                                                    <small class="text-danger error" id="product_id_error"></small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea class="form-control" name="message" id="message" rows="1" placeholder="Review"
                                                        onfocus="this.placeholder = 'Message'" onblur="this.placeholder = 'Message'"></textarea>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <small class="text-danger error" id="rating_error"></small>
                                            </div>
                    ...
                    $('#feedback').submit(function(e) {
                        ...
                        reusableAjaxCall(url, 'POST', formData, function(response) {
                            ...
                            function(xhr, error) {
                                ...
                                if (xhr.status === 409) {
                                    let message = xhr.responseJSON?.message ?? "Feedback already submitted";
                                    Toast.fire({
                                        icon: "error",
                                        title: message
                                    });
